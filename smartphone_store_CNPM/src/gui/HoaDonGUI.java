...
public class HoaDonGUI extends JPanel {
    ...
    public JPanel createPnInfor() {
        ...
        String[] thuoc_tinh = {
            "Mã hóa đơn: ", "Mã khách hàng: ", "Mã nhân viên: ", "Ngày xuất: ", "Tổng tiền: ", "Khuyến Mãi: "
        };
    ...
    public JPanel createPnTable() {
        ...
        table.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                arrLbInfor.get(5).setText("Khuyến Mãi: " + table.getModel().getValueAt(row, 5).toString());
    ...
    public void reloadHD(ArrayList<HoaDonDTO> hdList) {
        ...
        for (HoaDonDTO hd : hdList) {
            model.addRow(new Object[]{
                hd.getIdHoaDon(), hd.getIdKhachHang(), hd.getIdUser(), hd.getNgayXuat(), hd.getTongTien(), hd.getIdKhuyenMai()
            });
        }
    } 
