...
public class LoginGUI extends JFrame implements MouseListener {
    ...
    public JPanel pnCenter() {
        ...
        lb_text_login.setForeground(Color.decode("#B22222"));
        ...
        this.tf_user.setBorder(BorderFactory.createLineBorder(Color.decode("#FF6347"), 2));
        this.tf_password.setBorder(BorderFactory.createLineBorder(Color.decode("#FF6347"), 2));
        ...
        lb_username.setForeground(Color.decode("#FF6347"));
        ...
        lb_password.setForeground(Color.decode("#FF6347"));
    ...
    public JPanel pnSouth() {
        ...
        this.btn_login.setBackground(Color.decode("#B22222"));
