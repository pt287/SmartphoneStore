...
public class MainGUI extends JFrame implements MouseListener {
    ...
    public JPanel createHeader() {
        ...
        pn_header.setBackground(Color.decode("#800000"));

        JLabel lb_exit = new JLabel("", JLabel.CENTER);
        lb_exit.setOpaque(true);
        lb_exit.setBackground(Color.decode("#800000"));
        ...
        lb_exit.addMouseListener(new MouseListener() {
            ...
            public void mouseEntered(MouseEvent e) {
                lb_exit.setBackground(Color.decode("#B22222"));            
            }
    ...
    public JPanel createNav() {
        ...
        for (String cn : arr_cn) {
            if (cn.charAt(0) == '0') {
                String code = cn.substring(1);  // Lấy chuỗi từ ký tự thứ 2 trở đi
                switch (code) {
                    case "0":
                    ...
                    case "2":
                        ...
                        break;
                    case "3":
                        this.navName.add("Khuyến Mãi:laptop-white.png:laptop-1.png");
                        break;    
                    case "4":
        ...
        for (int i = 0; i < navName.size(); i++) {
            ...
            navModel.add(new NavModel(parts[0], 200, 40, parts[1], parts[2], this.color1, this.color2));
    ...
    public void changeMain(NavModel nav) {
        switch (nav.getNavName()) {
            ...
            case "Nhà cung cấp": // nha cung cap
                ...
                main.validate();
                break;
            case "Khuyến Mãi": // nha cung cap
                main.removeAll();
                main.add(new KhuyenMaiGUI(widthCenter, heightCenter, mapCN.get("13"), mapCN.get("23"), mapCN.get("33")));
                main.repaint();
                main.validate();
                break;    
            case "Sản phẩm": // san pham 
                main.removeAll();
                main.add(new SanPhamGUI(widthCenter, heightCenter, mapCN.get("14"), mapCN.get("24"), mapCN.get("34")));
                main.repaint();
                main.validate();
                break;
            case "Quyền": // quyen
                main.removeAll();
                main.add(new QuyenGUI(widthCenter, heightCenter, mapCN.get("15"), mapCN.get("25"), mapCN.get("35")));
                main.repaint();
                main.validate();
                break;
            case "Bảo hành": // baohanh 
                main.removeAll();
                main.add(new CTBaoHanhGUI(widthCenter, heightCenter, user, mapCN.get("16"), mapCN.get("26"), mapCN.get("36")));
                main.repaint();
                main.validate();
                break;    
            case "Bán hàng": // ban hang
                main.removeAll();
                main.add(new BanHangGUI(widthCenter, heightCenter, user, mapCN.get("17"), mapCN.get("27"), mapCN.get("37")));
                main.repaint();
                main.validate();
                break;
            case "Nhập hàng": // nhap hang
                main.removeAll();
                main.add(new NhapHangGUI(widthCenter, heightCenter, user, mapCN.get("18"), mapCN.get("28"), mapCN.get("38")));
                main.repaint();
                main.validate();
                break;
